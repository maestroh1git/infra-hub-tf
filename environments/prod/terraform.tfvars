...
# Subnet Configuration (production with full multi-AZ coverage)
public_subnet_cidr_blocks = ["10.2.1.0/24", "10.2.2.0/24", "10.2.3.0/24"]
app_subnet_cidr_blocks    = ["10.2.4.0/24", "10.2.5.0/24", "10.2.6.0/24"]
availability_zones        = ["us-east-2a", "us-east-2b", "us-east-2c"] # Full 3 AZs for production HA
...
domain_name                                 = "maestrohwithit.com"
dns_domain_name                             = "maestrohwithit.com"
validation_method                           = "DNS"
key_algorithm                               = "RSA_2048"
certificate_transparency_logging_preference = "ENABLED"
name                                        = "maestrohwithit-prod-cert"
...
# EC2 Configuration (production-grade instances)
...
key_name                    = "maestrohwithit-prod-key"
instance_count              = 2  # At least 2 instances for production HA
